...
with st.sidebar:
    ...
    if uploaded_file_ui and "doc_ref" not in st.session_state:
        ...
        st.success("Your document has been uploaded to your chat successfully.")

if "messages" not in st.session_state:
    st.session_state.messages = [] # creates a list of dictionaries where each oe is a message containing role and content
